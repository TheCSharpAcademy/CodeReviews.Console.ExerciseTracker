...
public class WeightController
{
    ...
    public WeightController(WeightService service, UserInput userInput)
    {
        _service = service;
    ...
    public async Task Run()
    {
        ...
        {
            Console.Clear();
            View.RenderTitle("Weights (EntityFramework)", Color.CadetBlue, Color.Teal, "WEIGHT DATA", "red", BoxBorder.Heavy);
            var selection = _userInput.ChooseWeightDataOperation();

            switch (selection)
            {
                case "Get All Weights":
                    Console.Clear();
